        ...
        {posts.map((post) => (
          <li key={post.slug} className="border border-black p-6">
            <Link href={`/post/${post.slug}`}>
              <div>{post.mdxMetaData.title}</div>
              <div>{post.mdxMetaData.description}</div>
              <div>{post.mdxMetaData.date}</div>
              <div>{post.mdxMetaData.tags}</div>
            </Link>
          </li>
        ))}
      </ul>

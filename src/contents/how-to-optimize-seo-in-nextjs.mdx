...
![gsc_add_property](/images/how-to-optimize-seo-in-nextjs/gsc_add_property.png)

속성 추가하기 버튼을 클릭하게 되면 도메인 혹은 URL 접두어를
입력하라고 나오는데 저는 URL 접두어로 제 사이트를 등록했습니다.

![gsc_select_property](/images/how-to-optimize-seo-in-nextjs/gsc_select_property.png)

웹사이트 속성 등록이 완료되면, Sitemaps 탭에서 `sitemap.xml`을 제출해주시면 됩니다.
`sitemap.xml`을 제출하면 Googlebot이 사이트 구조를 더 빠르게 이해하고 색인 작업을 수행할 수 있습니다.

![gsc_add_sitemap](/images/how-to-optimize-seo-in-nextjs/gsc_add_sitemap.png)
